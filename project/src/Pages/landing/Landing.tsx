...
export default function Landing() {
    return (
        <section>
            ...
            <section className="w-full px-6 sm:px-10 min-[900px]:px-20 lg:px-32 xl:px-40 py-1 pb-16 md:pb-24 bg-[#F0F3FC]">
                <div className="max-w-full mx-auto flex flex-col-reverse min-[900px]:flex-row gap-8 sm:gap-12 min-[900px]:gap-[30px] lg:gap-[30px] xl:gap-[30px] items-start">
                    ...
                    <div className="w-full min-[900px]:w-4/5 text-center min-[900px]:text-left space-y-8 sm:space-y-10 min-[900px]:ml-10">
                        <div className="text-center min-[900px]:text-left space-y-0 leading-none">
                            ...
                            <h2 className="text-[#1080ff] text-[40px] sm:text-[44px] min-[900px]:text-[52px] lg:text-[90px] font-bold">
                                CampusCircle
                            </h2>
                        </div>
                        ...
                        <Link to="/signin" className="mt-8 min-[900px]:mt-12 block">
                            <Button
                                variant="hero"
            ...
            <section className="w-full my-5 bg-[#F0F3FC]">
            ...
            <section className="w-full my-5 bg-[#F0F3FC]">
                <div className="relative w-full h-[3px] bg-[#F0F3FC]">
                    <div className="absolute inset-0 h-[3px] bg-gradient-to-r from-[#F0F3FC] via-gray-300 to-[#F0F3FC] bg-[#F0F3FC]"></div>
                </div>
            </section>
